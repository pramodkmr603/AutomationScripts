package com.specreader.automation.mip;
...
public class Mip {//MIP-00000009
		...
		public void lifecycle_approval_review() {
			...
			d.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			try {
				if(d.findElement(By.xpath("//*[@id=\"print\"]/div[2]/div/div[3]/div[1]/div")).isDisplayed())
					...
					//			if(d.findElement(By.linkText("Lifecycle/Approval Powerview")).isDisplayed())
				{
					...
					WebElement lifetable=d.findElement(By.xpath("//*[@id=\"seven\"]"));
		...
		public void ownership() {
			...
			d.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			try {
				if(d.findElement(By.xpath("//*[@id=\"print\"]/div[2]/div/div[4]/div[1]/div")).isDisplayed())
					...
					//			if(d.findElement(By.linkText("Ownership")).isDisplayed())
				{
					...
					WebElement content=d.findElement(By.id("eight"));
		...
		public void ipclass() {
			...
			try {
					...
					//			if(d.findElement(By.linkText("IP Classes")).isDisplayed())
				{
					...
					WebElement table=d.findElement(By.xpath("//*[@id=\"nine\"]/div/div/table/thead"));
		...
		public void Performance_Characteristic() {
			...
			try {
				if(d.findElement(By.xpath("//*[@id=\"print\"]/div[2]/div/div[2]/div[1]/div")).isDisplayed())
				{
					...
					List<String>perfolist1=new ArrayList<String>();
					WebElement table=d.findElement(By.xpath("//*[@id=\"six\"]/div/div/table/thead"));
					List<WebElement>rows=table.findElements(By.tagName("tr"));
					...
					List<String>p=new ArrayList<String>();
					WebElement table2=d.findElement(By.xpath("//*[@id=\"six\"]/div/div/table/tbody"));
		...
		public void BillOfMaterials() {
			...
			d.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			try {
				if(d.findElement(By.linkText("BillOfMaterials")).isDisplayed())
				{}
			}
			catch(Exception e) {
		...
		public void beforeClass() throws InterruptedException {
			...
			d.findElement(By.id("searchBox")).sendKeys("MIP");
			d.manage().timeouts().implicitlyWait(100, TimeUnit.SECONDS);
			d.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[1]/div/div/form/div/div[1]/div/button")).click();
			d.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
			d.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[2]/div/div/div[2]/div/div/div/div/table/tbody/tr[2]/td[1]/a")).click();			
